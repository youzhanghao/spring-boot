...
import com.demo.springUtil.redis.RedisConnector;
...
//
    ...
    public <T> T execute(String key, HashRedisExecutor<T> executor) {
        JedisPool[] jedisPools = redisConnector.jedisPools;
    ...
    public  Set<String> keys(String pattern){
        return execute(pattern, new HashRedisExecutor<Set<String>>() {
            @Override
            public Set<String> execute(Jedis jedis) {
...
//    }
    ...
    public static void main(String[] args){
        try{
            ...
            System.out.println(redisUtil.set("keyTest02","valueTest02"));
            System.out.println(redisUtil.get("keyTest02"));
        }catch (Exception e){
            e.printStackTrace();
        }finally {
